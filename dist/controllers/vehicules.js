...
vehiculesRouter.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, immat, registration_date, model_id_model, user_id_user, types_id_type, url_vehiculeRegistration, vehicules;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, immat = _a.immat, registration_date = _a.registration_date, model_id_model = _a.model_id_model, user_id_user = _a.user_id_user, types_id_type = _a.types_id_type, url_vehiculeRegistration = _a.url_vehiculeRegistration;
